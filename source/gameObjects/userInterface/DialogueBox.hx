...
class DialogueBox extends FlxSpriteGroup
{
	...
	{
		var dialoguePath = SUtil.getStorageDirectory() + Paths.file('assets/images/dialogue/portraits/$curCharacter/$file');
		var truePath = SUtil.getStorageDirectory() + Paths.file(file);
	...
	public function updateTextBox(force:Bool = false)
	{
		...
		if (curBoxState != newState || force)
		{
			...
			var boxJson = SUtil.getStorageDirectory() + Paths.file('images/dialogue/boxes/$curBox/$curBox.json');
	...
	public function updatePortrait(force:Bool = false)
	{
		...
		if (curCharacter != newChar || force)
		{
			if (newChar != null)
			{
				...
				var portraitJson = SUtil.getStorageDirectory() + Paths.file('images/dialogue/portraits/$curCharacter/$curCharacter.json');
